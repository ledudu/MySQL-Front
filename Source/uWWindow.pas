...
begin
  uBase.aDCancel := aDCancel;
  uBase.aDCancelRecord := aDCancelRecord;
  uBase.aDCreateDatabase := aDCreateDatabase;
  uBase.aDCreateEvent := aDCreateEvent;
  uBase.aDCreateField := aDCreateField;
  uBase.aDCreateForeignKey := aDCreateForeignKey;
  ...
  uBase.aDCreateView := aDCreateView;
  uBase.aDDeleteDatabase := aDDeleteDatabase;
  uBase.aDDeleteEvent := aDDeleteEvent;
  uBase.aDDeleteField := aDDeleteField;
  uBase.aDDeleteForeignKey := aDDeleteForeignKey;
  uBase.aDDeleteKey := aDDeleteKey;
  ...
  uBase.aDDeleteView := aDDeleteView;
  uBase.aDEditDatabase := aDEditDatabase;
  uBase.aDEditEvent := aDEditEvent;
  uBase.aDEditField := aDEditField;
  uBase.aDEditForeignKey := aDEditForeignKey;
  uBase.aDEditKey := aDEditKey;
  uBase.aDEditProcess := aDEditProcess;
  ...
  uBase.aDEditVariable := aDEditVariable;
  uBase.aDEditView := aDEditView;
  uBase.aDEmpty := aDEmpty;
  uBase.aDInsertRecord := aDInsertRecord;
  uBase.aDPostObject := aDPostObject;
  uBase.aDPostRecord := aDPostRecord;
  uBase.aDRun := aDRun;
  uBase.aDRunSelection := aDRunSelection;
  uBase.aECopy := aECopy;
  uBase.aECopyToFile := aECopyToFile;
  uBase.aECut := aECut;
  uBase.aEDelete := aEDelete;
  uBase.aEFind := aEFind;
  uBase.aEFormatSQL := aEFormatSQL;
  uBase.aEPaste := aEPaste;
  uBase.aEPasteFromFile := aEPasteFromFile;
  uBase.aERedo := aERedo;
  uBase.aERename := aERename;
  uBase.aEReplace := aEReplace;
  uBase.aESelectAll := aESelectAll;
  uBase.aETransfer := aETransfer;
  uBase.aEUndo := aEUndo;
  uBase.aFClose := aFClose;
  uBase.aFCloseAll := aFCloseAll;
  uBase.aFExit := aFExit;
  uBase.aFExportAccess := aFExportAccess;
  uBase.aFExportBitmap := aFExportBitmap;
  uBase.aFExportExcel := aFExportExcel;
  uBase.aFExportHTML := aFExportHTML;
  uBase.aFExportODBC := aFExportODBC;
  uBase.aFExportPDF := aFExportPDF;
  uBase.aFExportSQL := aFExportSQL;
  uBase.aFExportText := aFExportText;
  uBase.aFExportXML := aFExportXML;
  uBase.aFImportAccess := aFImportAccess;
  uBase.aFImportExcel := aFImportExcel;
  uBase.aFImportODBC := aFImportODBC;
  uBase.aFImportSQL := aFImportSQL;
  uBase.aFImportText := aFImportText;
  uBase.aFOpen := aFOpen;
  uBase.aFOpenAccount := aFOpenAccount;
  uBase.aFSave := aFSave;
  uBase.aFSaveAs := aFSaveAs;
  uBase.aHIndex := aHIndex;
  uBase.aHInfo := aHInfo;
  uBase.aHManual := aHManual;
  uBase.aHSQL := aHSQL;
  uBase.aHUpdate := aHUpdate;
  uBase.aOAccounts := aOAccounts;
  uBase.aOGlobals := aOGlobals;
  uBase.aOExport := aOExport;
  uBase.aOImport := aOImport;
  uBase.aVBrowser := aVBrowser;
  uBase.aVBuilder := aVBuilder;
  uBase.aVDiagram := aVDiagram;
  uBase.aVExplorer := aVExplorer;
  uBase.aVNavigator := aVNavigator;
  uBase.aVObjects := aVObjects;
  uBase.aVIDE := aVIDE;
